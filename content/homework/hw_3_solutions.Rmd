...
\color{blue}
The approximate distribution of $n\sum_{l = 1}^h \hat{\rho}_y\left(h\right)^2$ will be $\chi^2_h$, because $n\sum_{l = 1}^h \hat{\rho}_y\left(h\right)^2$ can be rewritten as the sum of $h$ squared independent squared normal random variables.
\color{black}
